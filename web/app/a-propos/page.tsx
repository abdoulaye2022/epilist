...
export const metadata: Metadata = {
  ...
  description:
    "👥 Découvrez l'équipe EpiList basée au Nouveau-Brunswick. Notre mission : simplifier les courses familiales. 50k+ familles nous font confiance depuis 2024.",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "Startup tech maritime • Mission familiale • 50k+ utilisateurs • Gratuit à vie",
