...
import { ArrowLeft, Mail, Send, MapPin, Phone, Clock, CheckCircle, User, MessageSquare, FileText } from 'lucide-react';
                ...
                <CardContent className="p-0">
                  {isSubmitted ? (
                    <div className="p-12 text-center bg-gradient-to-br from-green-50 to-epilist-green/10">
                      ...
                      <h3 className="text-3xl font-bold text-gray-900 mb-4">{t('messageSent')}</h3>
                      <p className="text-gray-600 text-lg">{t('messageConfirmation')}</p>
                    </div>
                  ) : (
                    <div className="p-8 md:p-12">
                      <div className="mb-8">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">{t('getInTouch')}</h2>
                        <p className="text-gray-600 text-lg">{t('contactFormDescription')}</p>
                      </div>
              ...
              <Card className="shadow-xl border-0">
                <CardContent className="p-8">
                  <div className="flex items-center space-x-3 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900">{t('businessHours')}</h3>
                  </div>
              ...
              <Card className="shadow-xl border-0">
                <CardContent className="p-8 bg-gradient-to-br from-epilist-blue/5 to-epilist-green/5">
                  ...
                  <div className="space-y-3">
                    <Link href="/support" className="flex items-center space-x-3 p-3 rounded-xl hover:bg-white transition-colors group">
                      ...
                      <span className="text-gray-700 group-hover:text-epilist-green transition-colors">{t('helpCenter')}</span>
                    </Link>
                    
                    <Link href="/privacy" className="flex items-center space-x-3 p-3 rounded-xl hover:bg-white transition-colors group">
                      ...
                      <span className="text-gray-700 group-hover:text-epilist-blue transition-colors">{t('privacyPolicy')}</span>
                    </Link>
                    
                    <Link href="/terms" className="flex items-center space-x-3 p-3 rounded-xl hover:bg-white transition-colors group">
                      <div className="w-8 h-8 bg-epilist-green/20 rounded-lg flex items-center justify-center group-hover:bg-epilist-green group-hover:text-white transition-colors">
                        <FileText className="h-4 w-4" />
                      </div>
                      <span className="text-gray-700 group-hover:text-epilist-green transition-colors">{t('termsOfService')}</span>
                    </Link>
                  </div>
                </CardContent>
              </Card>
